...
class SimpleTranslationDataset(Dataset):
    ...
    def __init__(
        self, src_file: str, tgt_file: str, tokenizer_model: str, max_length: int = 128
    ):
...
def train_epoch_advanced(
    model, dataloader, optimizer, criterion, device, scheduler, grad_clip=1.0
):
...
def main():
    ...
    optimizer = optim.AdamW(
        model.parameters(), lr=config["base_lr"], weight_decay=0.01, betas=(0.9, 0.98)
    )
