...
def main():
    ...
    parser.add_argument(
        "--train-json", default="data/processed_large_simple/train_data.json"
    )
    parser.add_argument(
        "--val-json", default="data/processed_large_simple/val_data.json"
    )
    parser.add_argument(
        "--test-json", default="data/processed_large_simple/test_data.json"
    )
    ...
    # Convert files
    train_count = convert_tsv_to_json(
        args.train_tsv, args.train_json, args.max_train_samples
    )
