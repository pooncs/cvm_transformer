...
tokenizer = spm.SentencePieceProcessor(model_file='data/processed_large_simple/sentencepiece_large.model')
...
simple_tokenizer = spm.SentencePieceProcessor(model_file='data/tokenizers/kr_en_simple.model')
