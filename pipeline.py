...
def main():
    ...
    parser.add_argument('--stage', choices=['all', 'data', 'train', 'validate', 'test'], 
                       default='all', help='Pipeline stage to run')
    parser.add_argument('--data-size', type=int, default=50000, help='Number of training samples')
    parser.add_argument('--epochs', type=int, default=30, help='Training epochs')
    parser.add_argument('--batch-size', type=int, default=16, help='Batch size')
    parser.add_argument('--learning-rate', type=float, default=5e-5, help='Learning rate')
    parser.add_argument('--accuracy-threshold', type=float, default=99.0, help='Accuracy threshold')
    ...
    if args.stage in ['all', 'train']:
        ...
        success &= run_command(train_cmd, "Extended training with advanced configuration")
    ...
    if success:
        ...
        print(f"✓ Translation system ready with {args.accuracy_threshold}% accuracy target")
        return 0
    else:
        print("\n❌ Pipeline failed!")
        return 1
